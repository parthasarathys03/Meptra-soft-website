...
export const landings = [
  ...
  },
  {
    ...
    path: "/courses/ai",
    accent: "amber",
    image: "/assets/New folder/ai 2nd- learn.png",
  ...
  },
  {
    ...
    path: "/courses/python",
    accent: "amber",
    image: "/assets/New folder/python courses.png",
  ...
  },
  {
    ...
    accent: "amber",
    image: "/assets/New folder/final year projects.png",
    imageWide: true,
    imageClassName: "md:scale-125 lg:scale-130 origin-center md:origin-right",
